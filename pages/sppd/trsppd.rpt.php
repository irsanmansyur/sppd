...
if (!empty($dbRow)) {
	...
	$vaTable2	 	= array();
	$vaTable2[] 	= array(
		"1" => "1.", "2" => "Pejabat berwenang yang memberi perintah	",
		"3" => " " . $vaPejabat['jabatan']
	);
	$vaTable2[] 	= array(
		"1" => "2.", "2" => "Nama/NIP Pegawai yang diperintah	",
		"3" => " " . $vaLeader['nama']
	);
	$vaTable2[] 	= array(
		"1" => "3.", "2" => "a. Pangkat dan Golongan menurut PP. No 6 Tahun 1997	",
	...
	$vaUntuk[]		= array("1" => "Pembebanan Anggaran", "2" => ": ");
	$nFont		= 11;
	...
	array(
		"x"	=> array("width" => 50, "wrap" => 1, "justification" => "center"),
	...
	$pdf->ezText("NOMOR : ", $nFont, array("justification" => "center"));
	$pdf->ezText("");
