...
class Cezpdf extends Cpdf
{
  ...
  function ezImage(
    ...
    if ($type == "jpeg") {
      $this->addJpegFromFile(
        $image,
        $this->ez['leftMargin'] + $padLeft + $offset + $vaMargin['Left'],
        $this->y + $this->getFontHeight($this->ez['fontSize']) - $padTop - $height + $vaMargin['Top'],
        $width
      );
    } else if ($type == "png") {
      $this->addPngFromFile(
  ...
  function ezTable(&$data, $cols = '', $title = '', $options = '')
  {
    ...
    $defaults = array(
      'shaded' => 0, 'showLines' => 2, 'shadeCol' => array(0.8, 0.8, 0.8), 'shadeCol2' => array(0.7, 0.7, 0.7), 'fontSize' => 10, 'titleFontSize' => 11, 'titleGap' => 5, 'lineCol' => array(0, 0, 0), 'gap' => 5, 'xPos' => 'centre', 'xOrientation' => 'centre', 'showHeadings' => 1, 'widthType' => 0, 'textCol' => array(0, 0, 0), 'width' => 0, 'maxWidth' => 0, 'cols' => array(), 'minRowSpace' => -100, 'rowGap' => 2, 'rowHeadGap' => 2, 'colGap' => 2, 'innerLineThickness' => 1, 'outerLineThickness' => 1, 'splitRows' => 0, 'protectRows' => 1
    );
